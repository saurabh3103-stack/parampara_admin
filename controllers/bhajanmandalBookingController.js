...
const { bhajanMandaliBookingUser } = require('./bhajanmandalController');
...
const cancelBhajanMandalOrder = async (req, res) => {
  try {
    ...
    console.log("bhajan order is ",bhajanOrder)
    console.log("user order is ",user)


    await sendEmail(
      user.email,
      'Bhajan Mandali Booking Cancelled',
      'bhajanmandaliordercancelled',
      {
        user: user,
        booking: bhajanOrder,
      },
